/*
 * $Id: cmpiSMIS_FCPortControllerProvider.c,v 1.1.1.1 2009/05/12 21:46:33 nsharoff Exp $
 *
 ...
 *
 * Description:
 *      Provider for FC Port Controller.
*/
...
/******************************************************************************/
/* Function: SMIS_FCPortControllerProviderCleanup                             */
/******************************************************************************/
CMPIStatus SMIS_FCPortControllerProviderCleanup( CMPIInstanceMI * mi,
...
/******************************************************************************/
/* Function: SMIS_FCPortControllerProviderEnumInstanceNames                   */
/******************************************************************************/
CMPIStatus SMIS_FCPortControllerProviderEnumInstanceNames( CMPIInstanceMI * mi,
   ...
   if( lptr != NULL ) 
      ...
      for ( ; lptr && rc.rc == CMPI_RC_OK ; lptr = lptr->next) 
         {
         op = _makePath_FCPortController( _broker, ctx, ref,lptr->sptr, &rc );
   ...
   return rc;
   } /* End SMIS_FCPortControllerProviderEnumInstanceNames */
...
/******************************************************************************/
/* Function: SMIS_FCPortControllerProviderEnumInstances                       */
/******************************************************************************/
CMPIStatus SMIS_FCPortControllerProviderEnumInstances( CMPIInstanceMI * mi,
            const CMPIContext * ctx,
            const CMPIResult * rslt,
            const CMPIObjectPath * ref,
   ...
   if( lptr != NULL ) 
      ...
      for ( ; lptr && rc.rc == CMPI_RC_OK ; lptr = lptr->next) 
         {
         ci = _makeInst_FCPortController( _broker, ctx, ref, lptr->sptr, &rc );
   ...
   return rc;
   } /* end SMIS_FCPortControllerProviderEnumInstances */
...
/******************************************************************************/
/* Function: SMIS_FCPortControllerProviderGetInstance                         */
/******************************************************************************/
CMPIStatus SMIS_FCPortControllerProviderGetInstance( CMPIInstanceMI * mi,
            const CMPIContext * ctx,
            const CMPIResult * rslt,
   ...
   if( id == NULL ) 
      {
      CMSetStatusWithChars( _broker, &rc,
                           CMPI_RC_ERR_FAILED, "Could not get FCPortControllerID." );
      _OSBASE_TRACE(2,("--- %s CMPI GetInstance() failed : %s",_ClassName,CMGetCharPtr(rc.msg)));
      return rc;
      }
   ...
   ci = _makeInst_FCPortController( _broker, ctx, cop, sptr, &rc );
   ...
   return rc;
   } /* end SMIS_FCPortControllerProviderGetInstance */
...
/******************************************************************************/
/* Function: SMIS_FCPortControllerProviderCreateInstance                      */
...
/******************************************************************************/
CMPIStatus SMIS_FCPortControllerProviderCreateInstance( CMPIInstanceMI * mi,
            const CMPIContext * ctx,
            const CMPIResult * rslt,
            const CMPIObjectPath * cop,
...
/******************************************************************************/
/* Function: SMIS_FCPortControllerProviderModifyInstance                      */
/* Notes: This method is only here as a stub in case we later support some    */
/*        methods and not others, and to catch a call to this method in case  */
/*        it is not set to unsupported (or no methods supported) elsewhere.   */
/******************************************************************************/
CMPIStatus SMIS_FCPortControllerProviderModifyInstance( CMPIInstanceMI * mi,
            const CMPIContext * ctx,
            const CMPIResult * rslt,
            const CMPIObjectPath * cop,
            const CMPIInstance * ci,
...
/******************************************************************************/
/* Function: SMIS_FCPortControllerProviderDeleteInstance                      */
/* Notes: This method is only here as a stub in case we later support some    */
/*        methods and not others, and to catch a call to this method in case  */
/*        it is not set to unsupported (or no methods supported) elsewhere.   */
/******************************************************************************/
CMPIStatus SMIS_FCPortControllerProviderDeleteInstance( CMPIInstanceMI * mi,
            const CMPIContext * ctx,
            const CMPIResult * rslt,
            const CMPIObjectPath * cop) 
   {
...
/******************************************************************************/
/* Function: SMIS_FCPortControllerProviderExecQuery                           */
/* Notes: This method is only here as a stub in case we later support some    */
/*        methods and not others, and to catch a call to this method in case  */
/*        it is not set to unsupported (or no methods supported) elsewhere.   */
/******************************************************************************/
CMPIStatus SMIS_FCPortControllerProviderExecQuery( CMPIInstanceMI * mi,
            const CMPIContext * ctx,
            const CMPIResult * rslt,
            const CMPIObjectPath * ref,
            const char * lang,
...
/******************************************************************************/
/* Function: SMIS_FCPortControllerProviderMethodCleanup                       */
/******************************************************************************/
CMPIStatus SMIS_FCPortControllerProviderMethodCleanup( CMPIMethodMI * mi,
            const CMPIContext * ctx, CMPIBoolean trm) 
   {
...
/******************************************************************************/
/* Function: SMIS_FCPortControllerProviderInvokeMethod                        */
/******************************************************************************/
CMPIStatus SMIS_FCPortControllerProviderInvokeMethod( CMPIMethodMI * mi,
            const CMPIContext * ctx,
            const CMPIResult * rslt,
            const CMPIObjectPath * ref,
   ...
   return rc;
   } /* end SMIS_FCPortControllerProviderInvokeMethod */
...
CMInstanceMIStub( SMIS_FCPortControllerProvider,
                  SMIS_FCPortControllerProvider,
                  _broker,
                  CMNoHook)

CMMethodMIStub( SMIS_FCPortControllerProvider,
                SMIS_FCPortControllerProvider,
                _broker,
                CMNoHook)
...
/* ---------------------------------------------------------------------------*/
/*                end of cmpiSMIS_FCPortControllerProvide                     */
/* ---------------------------------------------------------------------------*/
